...
| ------ | ---------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
| TC_001 | Đăng ký với thông tin hợp lệ       | Không có tài khoản với email đã nhập                | 1. Đi đến trang đăng ký<br>2. Nhập email, mật khẩu, xác nhận mật khẩu<br>3. Nhấn "Đăng ký" | Email: "test@abc.com"<br>Mật khẩu: "Abc12345"<br>Xác nhận mật khẩu: "Abc12345" | Tài khoản được tạo, hiển thị thông báo: "Vui lòng kiểm tra email để xác minh", chuyển sang màn hình xác thực |
